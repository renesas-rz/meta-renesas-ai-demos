...
setenv bootcmd 'ext4load mmc 0 0x48080000 boot/Image; ext4load mmc 0 0x48000000 boot/r8a774e1-hihope-rzg2h-ex.dtb; booti 0x48080000 - 0x48000000'
```
For the RZ/G2M:
```
setenv bootargs 'rw root=/dev/mmcblk0p1 rootwait'
setenv bootcmd 'ext4load mmc 0 0x48080000 boot/Image; ext4load mmc 0 0x48000000 boot/r8a774a1-hihope-rzg2m-ex.dtb; booti 0x48080000 - 0x48000000'
```
For the RZ/G2E:
```
setenv bootargs 'rw root=/dev/mmcblk0p1 rootwait'
setenv bootcmd 'ext4load mmc 0 0x48080000 boot/Image; ext4load mmc 0 0x48000000 boot/r8a774c0-ek874.dtb; booti 0x48080000 - 0x48000000'
```
